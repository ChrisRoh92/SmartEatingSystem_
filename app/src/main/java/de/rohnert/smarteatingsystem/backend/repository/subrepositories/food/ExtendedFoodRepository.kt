package de.rohnert.smarteatingsystem.backend.repository.subrepositories.food

import android.app.Application
import androidx.lifecycle.LiveData
import de.rohnert.smarteatingsystem.backend.databases.food_database.extend_database.ExtendedFood
import de.rohnert.smarteatingsystem.backend.databases.food_database.extend_database.appfood_extend_database.AppFoodExtendDao
import de.rohnert.smarteatingsystem.backend.databases.food_database.extend_database.appfood_extend_database.AppFoodExtendDataBaseProvider
import de.rohnert.smarteatingsystem.backend.databases.food_database.extend_database.userfood_extend_database.UserFoodExtendDao
import de.rohnert.smarteatingsystem.backend.databases.food_database.extend_database.userfood_extend_database.UserFoodExtendDataBaseProvider
import de.rohnert.smarteatingsystem.backend.databases.food_database.normal_database.favourite_foods.FavFood
import de.rohnert.smarteatingsystem.backend.databases.food_database.normal_database.favourite_foods.FavFoodDao
import de.rohnert.smarteatingsystem.backend.databases.food_database.normal_database.favourite_foods.FavFoodDataBaseProvider
