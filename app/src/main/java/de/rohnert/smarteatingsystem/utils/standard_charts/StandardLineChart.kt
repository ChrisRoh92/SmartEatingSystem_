...
class StandardLineChart(var id:Int, var view: View, var yContent:ArrayList<Double>,var xValues:ArrayList<String>,
                        var labels:ArrayList<String> = arrayListOf("Set 1","Set 2"),var yIndices:ArrayList<Float> = ArrayList())
{
